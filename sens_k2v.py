...
#%%
top = Path("/home/astro_02/AO2019-2/2019-10-24")
modelpath = Path(top/"ukk2v.dat")
modelspec = pd.read_csv(modelpath, skiprows=1,
...
specpath = top/"Specdata"
hd4628specpaths = list(specpath.glob("HD4628*"))
ngc676specpaths = list(specpath.glob("NGC676_raw*.csv"))
...
axs.set_title("NGC 676 Spectrum")
